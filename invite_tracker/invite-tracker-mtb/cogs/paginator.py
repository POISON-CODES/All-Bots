...
class Paginator(discord.ui.View):
    ...
    embeds: :class:`list`
        A list of `discord.Embed` for pagination
    """
    ...
    @discord.ui.button(label="Back", emoji="◀️", style=discord.ButtonStyle.green)
    ...
    @discord.ui.button(label="Random", emoji="🔢", style=discord.ButtonStyle.blurple)
    async def random_button(self, button, inter):
        self.value = self.btn_id.RANDOM
        self.current_page_set("random")
        await self.message.edit(embed=self.current_embed)

    @discord.ui.button(label="Jump", emoji="#️⃣", style=discord.ButtonStyle.blurple)
